...
# Expt 0 - lr=1e-4, training on extended simulations + generative model data + BLOCKGAPS_ALL
...
# Expt 1 - lr=1e-4, training on extended simulations + generative model data + RANDOMGAPS_ALL
