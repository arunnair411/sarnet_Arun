...
# CUDA_VISIBLE_DEVICES=1 python train.py --gpu-ids 0 --dataset=arun_extended_and_generative_testononlyfirsttwoseqs_randomgaps_allrates --store-dir=20201103_arun_extended_and_generative_testononlyfirsttwoseqs_randomgaps_allrates --save-test-val-results                                                                                                                                     --architecture=unetsar_arun --criterion-g=l1loss --batch-size=10 --test-batch-size=1000 --adam-lr=1e-4 --lr-step-size=100000 --epochs=1000
# Resume
...
## 10.160.199.26 - 2020-11-08
# Expt 2 - lr=1e-4, training on extended simulations + generative model data + kitchen sink (INTERFERENCE+ RANDOMGAPS_ALL + BLOCKGAPS_ALL)  - ended up running on GPU#2 of .26
# CUDA_VISIBLE_DEVICES=2 python train.py --gpu-ids 0 --dataset=arun_extended_and_generative_testononlyfirsttwoseqs_kitchensink --store-dir=20201108_arun_extended_and_generative_testononlyfirsttwoseqs_kitchensink --save-test-val-results                                                                                                                             --architecture=unetsar_arun --criterion-g=l1loss --batch-size=10 --test-batch-size=1000 --adam-lr=1e-4 --lr-step-size=100000 --epochs=1000
# Resume
# CUDA_VISIBLE_DEVICES=2 python train.py --gpu-ids 0 --dataset=arun_extended_and_generative_testononlyfirsttwoseqs_kitchensink --store-dir=20201108_arun_extended_and_generative_testononlyfirsttwoseqs_kitchensink --save-test-val-results --resume --checkpoint=checkpoints/20201108_arun_extended_and_generative_testononlyfirsttwoseqs_kitchensink/best_model.pt    --architecture=unetsar_arun --criterion-g=l1loss --batch-size=10 --test-batch-size=1000 --adam-lr=1e-4 --lr-step-size=100000 --epochs=1000
